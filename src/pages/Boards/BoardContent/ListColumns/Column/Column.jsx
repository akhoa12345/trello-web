...
function Column({ column, createNewCard }) {
  ...
  const dndKitColumnStyles = {
    ...
    transition,
    // Chiều cao phải luôn max 100% vì nếu không sẽ lỗi lúc kéo column ngắn qua 1 cái column dài thì phải
    // kéo ở khu vực giữa giữa rất khó chịu (demo ở video 32). Lưu ý lúc này phải kết hợp với {...listeners}
